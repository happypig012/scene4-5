...
public class DialogSystem : MonoBehaviour
{
    ...
    private void Awake()
	{
        ...
        //speakers[3].spriteRenderer.gameObject.SetActive(true); //처음엔 세종만 보이게함
    }
	...
	private void SetNextDialog()
	{
		...
		if(currentDialogIndex>=2 && currentSpeakerIndex!=3 && currentSpeakerIndex!=4 && currentSpeakerIndex != 5 && currentSpeakerIndex != 6 && currentSpeakerIndex != 7) //세종이 아닐 경우 이전의 금쪽이는 일러는 지워준다.
		{
